...
const storedPlaces = storedIds.map((id) => AVAILABLE_PLACES.find((place) =>
    place.id === id
  )
);
function App() {
    ...
    useEffect(() => {
        navigator.geolocation.getCurrentPosition((pos) => {
            ...
            const sortedPickedPlaces = sortPlacesByDistance(
              pickedPlaces,
              pos.coords.latitude,
              pos.coords.longitude
          );
            setPickedPlaces(sortedPickedPlaces);
        });
    }, []);
    ...
    function handleSelectPlace(id) {
        setPickedPlaces((prevPickedPlaces) => {
            ...
            const place = sortedAvailablePlaces.find((place) => place.id === id);
    ...
    const handleRemovePlace = useCallback(
      function handleRemovePlace() {
        ...
        const storedIds =
            ...
            localStorage.setItem(
              "selectedPlaces",
              JSON.stringify(storedIds.filter(
